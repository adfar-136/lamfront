    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <div className="text-center">
            ...
            >
              ...
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">For a Better Tomorrow</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <Link
                to="/courses"
                className="inline-flex items-center px-8 py-3 border border-transparent text-base font-medium rounded-lg text-indigo-600 bg-white hover:bg-gray-50 md:text-lg md:px-10 transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-xl"
              >
                Explore Courses
              </Link>
              <Link
                to="/hire-educators"
                className="inline-flex items-center px-8 py-3 border-2 border-indigo-600 text-base font-medium rounded-lg text-indigo-600 hover:bg-indigo-50 md:text-lg md:px-10 transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-xl"
              >
                Hire Educators
              </Link>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.2, duration: 0.8 }}
              className="relative bg-gradient-to-br from-indigo-50 to-purple-50 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300"
            >
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <div className="rounded-full bg-white p-2 shadow-lg">
                  <svg className="w-8 h-8 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16">
            <div className="lg:text-center mb-12">
              <h2 className="text-base text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600 font-semibold tracking-wide uppercase">Success Stories</h2>
              <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                    ...
                    <div className="p-6 text-center">
                      <div className="mb-4">
                        <img
                          ...
                          className="w-24 h-24 mx-auto rounded-full border-4 border-indigo-100 shadow-lg"
                        />
                      </div>
                      <h3 className="text-xl font-bold text-gray-900 mb-1">{testimonial.name}</h3>
                      <p className="text-indigo-600 font-medium mb-3">{testimonial.role}</p>
          ...
          <div>
            <div className="lg:text-center mb-12">
              <h2 className="text-base text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600 font-semibold tracking-wide uppercase">Trusted Partners</h2>
              <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                ...
                {partnerTestimonials.map((partner) => (
                  ...
                  >
                    <div className="p-6 text-center">
                      ...
                      <p className="text-indigo-600 font-medium mb-3">{partner.role}</p>
